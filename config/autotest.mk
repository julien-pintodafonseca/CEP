...
$(SIM_DIR)/%: %.s clean_res |$(SIM_DIR)
	...
	# Generate .irq
	@sed -e 's/#/# /g' < $< | awk '$$1=="#" && $$2=="irq_start", $$1=="#" && $$2=="irq_end" {if ($$2!~"irq") print $$2}' > $@/test_default.irq
	# generate .out
	@sed -e 's/#/# /g' < $< | awk '$$1=="#" && $$2=="pout_start", $$1=="#" && $$2=="pout_end" {if ($$2!~"pout") print $$2 " " $$3}' > $@/test_default.out
	# generate .setup
	@sed -e 's/#/# /g' < $< | awk '$$1=="#" && $$2=="max_cycle" {print $$3}' > $@/test_default.setup ;\
